...
public class About extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView cf =(TextView)findViewById(R.id.abu);
        TextView cf2 =(TextView)findViewById(R.id.abu2);
        TextView cf3 =(TextView)findViewById(R.id.abu3);
        cf.setTypeface(tf);
        cf2.setTypeface(tf);
        cf3.setTypeface(tf);
